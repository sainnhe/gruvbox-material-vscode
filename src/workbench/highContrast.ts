...
export function highContrastWorkbench(
  ...
  return {
    ...
    "list.activeSelectionBackground": `${palette.bg0}a0`,
    "list.inactiveSelectionForeground": `${palette.grey2}`,
    "list.inactiveSelectionBackground": `${palette.bg0}a0`,
    "list.dropBackground": `${palette.bg2}80`,
    "list.focusForeground": `${palette.fg0}`,
    "list.focusBackground": `${palette.bg0}a0`,
    "list.inactiveFocusBackground": `${palette.bg0}a0`,
