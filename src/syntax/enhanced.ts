...
export function getEnhancedSyntax(palette: Palette, italicComments: boolean) {
  let syntax = [
    // Syntax{{{
    {
      name: "String",
    ...
    // JSON{{{
    {
      name: "JSON grey",
      scope:
        "punctuation.support.type.property-name.end.json, punctuation.support.type.property-name.begin.json",
      settings: {
        foreground: palette.grey1,
      },
    },
